...
// Floating Social Media Buttons Component
  ...
  React.useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ...
      },
      {
        ...
        rootMargin: "0px 0px -40px 0px", // Start hiding 50px before footer enters viewport
      }
    );
  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        className="bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 hover:from-purple-700 hover:via-pink-600 hover:to-orange-500 text-white rounded-full p-4 shadow-lg transition-all duration-300"
        initial={{ scale: 0, x: 100 }}
        animate={{ scale: 1, x: 0 }}
